from sensors.sensor_config.base_sensor_config import BaseSensorConfig
import numpy as np
...
class BaseLidarConfig(BaseSensorConfig):
    ...
    vertical_fov_deg_min = -52
    vertical_fov_deg_max = +7
    ...
    pointcloud_in_world_frame = True  # Setting to true will return pointcloud in world frame
    ...
    min_translation =[0.0, -0.0, 0.0]# [0.07, -0.06, 0.01]
    max_translation =[0.0, -0.0, 0.0]# [0.12, 0.03, 0.04]
    min_euler_rotation_deg =[0.0, 0.0, 0.0]# [-5.0, -5.0, -5.0]
    max_euler_rotation_deg =[0.0, 0.0, 0.0]# [5.0, 5.0, 5.0]
